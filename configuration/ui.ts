...
export const CHAT_HEADER: string = `Chat with John's AI Portfolio Assistant`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `Customized AI by John Yuan @ UNC`;
export const CLEAR_BUTTON_TEXT: string = `Reset Chat`;
export const PAGE_TITLE: string = `Chat with Jonny`;
